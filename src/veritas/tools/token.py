...
class TokenCapability(VeritasCapability):
    ...
    def __init__(self, agent: Any):
        ...
        self.tools.append(VeritasTool(
            ...
            parameters={
                "type": "object",
                "properties": {
                    "token_address": {"type": "string", "description": "The contract address of the token"},
                    "to_address": {"type": "string", "description": "The destination address"},
                    "amount": {"type": "string", "description": "Amount to transfer in whole units (e.g. '1.5')"}
                },
        ...
        self.tools.append(VeritasTool(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "address": {"type": "string", "description": "Optional address to check balance for (defaults to agent's wallet)"}
                },
        ...
        self.tools.append(VeritasTool(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "amount": {"type": "string", "description": "Amount to approve in whole units (e.g. '100')"}
                },
        ...
        self.tools.append(VeritasTool(
            ...
            parameters={
                "type": "object",
                "properties": {"amount": {"type": "string", "description": "Amount of ETH to wrap (e.g. '0.1')"}},
                "required": ["amount"]
            }
        ))
        ...
        self.tools.append(VeritasTool(
            ...
            parameters={
                "type": "object",
                "properties": {"amount": {"type": "string", "description": "Amount of WETH to unwrap (e.g. '0.1')"}},
                "required": ["amount"]
            }
        ))

    def _get_contract(self, address: str, abi: list):
        return self.agent.w3.eth.contract(address=self.agent.w3.to_checksum_address(address), abi=abi)
    ...
    def get_balance(self, token_address: str, address: Optional[str] = None) -> Dict[str, Any]:
        ...
        balance = contract.functions.balanceOf(self.agent.w3.to_checksum_address(target_address)).call()
    ...
    def approve(self, token_address: str, spender_address: str, amount: str) -> Dict[str, Any]:
        ...
        return {"status": "success", "tx_hash": w3.to_hex(tx_hash), "amount": amount, "spender": spender_address}
