...
class VeritasAttestor:
    ...
    async def attest_root(self, merkle_root: str, schema_uid: Optional[str] = None, agent_id: str = "veritas-agent") -> str:
        """
        ...
        encoded_payload = encode(['bytes32', 'string', 'uint256'], [root_bytes, agent_id, timestamp])
