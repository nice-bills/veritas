...
class TestVeritasTools(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_contract.functions.transfer.return_value.build_transaction.return_value = {"data": "0x123"}
        self.mock_contract.functions.approve.return_value.build_transaction.return_value = {"data": "0x456"}
        self.mock_contract.functions.deposit.return_value.build_transaction.return_value = {"data": "0x789"}
        self.mock_contract.functions.withdraw.return_value.build_transaction.return_value = {"data": "0xabc"}
        self.mock_contract.functions.balanceOf.return_value.call.return_value = 1000000000000000000 # 1 ETH/Token
    ...
    def test_defi_capability(self):
        ...
        # Mock Supply
        self.mock_contract.functions.supply.return_value.build_transaction.return_value = {"data": "0xsupply"}
    ...
    def test_infra_capability(self):
        ...
        self.mock_contract.functions.getPrice.return_value.call.return_value = (200000000000, 100, -8, 1234567890) 
        
        res = cap.get_price("0xfeedid")
        self.assertEqual(res['price'], 2000.0)
        print("OK: Pyth Price")
